...
module ExportHelper
  MEMOIRE_EXPORT_COLS = [
    ...
    { nom: "COULEUR", desc: "Photographie en couleur", desc2: "Oui / Non" },
    { nom: "OBS", desc: "doute sur la localisation, sur le nom du photographe, fonction du photographe…",
      desc2: "" },
    { nom: "COM", desc: "Commune sous sa forme éditorialisée", desc2: "ex: Vouziers" },
    { nom: "DOM", desc: "Domaine : Objet ou Architecture", desc2: "objet" },
    { nom: "EDIF",
      desc: "Nom de l’édifice où se trouve l’objet. SI édifice protégé, reprendre l’appellation de Mérimée MH",
      desc2: "" },
    { nom: "COPY", desc: "Crédits", desc2: "© Ministère de la Culture…" },
    { nom: "TYPDOC", desc: "Type de documents", desc2: "Image numérique native" },
    { nom: "IDPROD", desc: "", desc2: "MHCO008" },
    { nom: "LIEUCOR", desc: "", desc2: "Collectif Objets" }
  ].freeze
