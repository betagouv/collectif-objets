class FillRecensementsMissingConservateurId < ActiveRecord::Migration[7.0]
  def up
    ...
    [
      # { code_insee: "21040", nom: "Avosnes", conservateur: "" },
      # { code_insee: "21100", nom: "Brain", conservateur: "" },
      # { code_insee: "21173", nom: "Chorey-les-Beaune", conservateur: "" },
      # { code_insee: "21197", nom: "Corpoyer-la-Chapelle", conservateur: "" },
      # { code_insee: "21304", nom: "Grancey-le-Château-Neuvelle", conservateur: "" },
      # { code_insee: "21596", nom: "Savouges", conservateur: "" },
