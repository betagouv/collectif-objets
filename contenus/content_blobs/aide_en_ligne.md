...
Si vous avez la possibilité d’être deux personnes pour effectuer le recensement, nous vous recommandons de former un tandem avec un observateur et un rédacteur :
...
Si votre commune n'a pas d'adresse email de contact indiquée dans ce site, ou si l'adresse email indiquée est obsolète, nous vous invitons à demander une mise à jour de vos coordonnées directement depuis le site de l'[Annuaire du service public](https://lannuaire.service-public.fr/)
